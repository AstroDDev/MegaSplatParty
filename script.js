...
function GeneratePlayerTexture(char){
    ...
    ctx.drawImage(AvatarImages.hat[char.hat].url, AvatarImages.hat[char.hat].offsets[char.hat % AvatarImages.hat[char.hat].offsets.length].x, AvatarImages.hat[char.hat].offsets[char.hat % AvatarImages.hat[char.hat].offsets.length].y);
